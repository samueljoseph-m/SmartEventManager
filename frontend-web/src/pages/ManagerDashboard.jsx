...
function ManagerDashboard() {
  ...
  const { logout, userRole } = useAuth(); // Get auth data from context (logout function and user role)
  ...
  if (userRole !== 'manager') {
    return null; // If the user is not a manager, render nothing
  }
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('/Event.webp')`, // Set background image
