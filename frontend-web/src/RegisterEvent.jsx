  ...
  return (
    ...
    >
      <div className={`w-full max-w-lg mx-auto p-6 ${theme === 'light' ? 'bg-neutral-100' : 'bg-neutral-800'} rounded-lg shadow-lg`}>
        ...
        <h1 className="text-4xl font-extrabold text-center text-primary-500 dark:text-secondary-500 mb-8">Smart Event Manager</h1>
        <h2 className="text-2xl font-bold text-center text-primary-900 dark:text-neutral-50 mb-6">Register for Event {eventId}</h2>
